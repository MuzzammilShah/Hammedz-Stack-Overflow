...
import './Auth.css'
import icon from '../../assets/loginicon2.png'
  ...
  return (
    <section class='auth-section'>
        ...
        <div class='auth-container-2'>
            { !isSignup && <img src={icon} alt='stack login icon' className='login-logo'/>}
                ...
                </label>
                {
                    isSignup && (
                        <label htmlFor='check'>
                            ...
                            <p style={{ color: "#666767", fontSize:"13px" }}>Opt-in to receive occasional product <br />updates, user research invitations, company <br />announcements, and digests.</p>
                        </label>
                    )
                }
